            ...
            <nav className="border-b border-gray-200 border-opacity-25 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        {darkMode && <BsSun onClick={()=>onToggle()} className="hover:opacity-50 cursor-pointer" /> }
                        {!darkMode && <BsFillMoonFill onClick={()=>onToggle()} className="hover:opacity-50 cursor-pointer" />}
                    </div>               
                </div>
            </nav>
        </header>
